      ...
      <svg 
        ...
        viewBox="0 0 50 50.25">
          ...
          <g id="Layer_4" data-name="Layer 4">
            <rect x="0.25" y="38" width="2.5" height="12" rx="1" fill={dark? '#fff': '#000'} />
          </g>
          <g id="Layer_4_copy" data-name="Layer 4 copy">
            <rect x="42.5" y="43" width="2.5" height="12" rx="1" transform="translate(-5.25 92.75) rotate(-90)" fill={dark? '#fff': '#000'}/>
          </g>
          </svg>
    </div>
  );
